...
// Import SplitTunnelConfig from config module
pub use crate::config::SplitTunnelConfig;
use crate::dns_cache::DnsResolver;

// Import built-in IP ranges module
#[path = "split_tunnel/builtin_ips.rs"]
mod builtin_ips;
pub use builtin_ips::get_country_ips;
#[allow(unused_imports)]
pub use builtin_ips::supported_countries;

// Import built-in domain lists
#[path = "split_tunnel/builtin_domains.rs"]
mod builtin_domains;
pub use builtin_domains::matches_china_domain;
#[allow(unused_imports)]
pub use builtin_domains::{matches_ad_domain, is_china_domain, is_ad_domain, matches_force_tunnel_domain};
#[allow(unused_imports)]
...
impl SplitTunnel {
    ...
    pub(crate) async fn resolve_host_to_ips(&self, host: &str) -> Option<Vec<IpAddr>> {
    ...
    async fn load_data(config: &SplitTunnelConfig) -> Result<SplitTunnelData> {
        ...
        // Load built-in IP ranges for configured countries
        ...
        let builtin_domain_count = if config.builtin_bypass_countries.contains(&"CN".to_string()) {
            builtin_domains::CHINA_DOMAINS.len()
        } else {
            0
        };
        info!(
