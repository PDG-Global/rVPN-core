...
## AGPL Requirements (Without Commercial License)
...
- Custom feature development (additional fees apply)
...
Commercial licenses are available under several models:

### Per-Deployment License
- One-time fee per production deployment
- Includes first year of support and updates
- Annual support renewal available

### SaaS/Service Provider License
- Annual subscription based on usage metrics
...
- Includes custom development hours
...
**PDG Global Limited**
- Website: https://pdg-global.com
- Email: license@pdg-global.com
- Address: Hong Kong SAR

Please include in your inquiry:
- Your company name and location
- Intended use case
- Expected scale (users, servers, locations)
...
A: Yes. You can purchase a commercial license at any time. Your previous AGPL compliance obligations are satisfied by the license purchase.
...
Even with a commercial license, we encourage you to:
...
*This document does not constitute a legal agreement. Specific license terms will be provided in the executed commercial license agreement.*
